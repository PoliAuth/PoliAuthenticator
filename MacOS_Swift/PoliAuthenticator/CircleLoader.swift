...
//  myPoliFile
//
//  Created starting from Pablo Garcia GeometricLoaders
//

import UIKit

public class CircleLoader: Loader {
    
    private var circles = [CAShapeLayer]()
    private let totalCircles = 4
    private var circleRadius :CGFloat = 8
    ...
    override internal func configureLoader() {
        ...
        loaderView.frame = CGRect(x: frame.origin.x, y: frame.origin.y, width: frame.width/12, height: frame.width/12)
